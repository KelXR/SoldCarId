<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/Guest.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SoldCardId.View.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class ="containerUp2">
        <asp:Button ID="insertBtn" runat="server" Text="Insert Car" Visible="false" OnClick="insertBtn_Click" CssClass="btn2"/>
    </div>
